...
#ifndef SPEEDTREE_COMMON_EMISSION_INCLUDED
#define SPEEDTREE_COMMON_EMISSION_INCLUDED
...
uniform sampler2D _IllumMap; //MY EDIT
...
void SpeedTreeFrag(Input IN, out SpeedTreeFragOut OUT)
{
	UNITY_APPLY_DITHER_CROSSFADE(IN)
		...
		OUT.Emission = tex2D(_MainTex, IN.mainTexUV)/* * IN.color*/ * tex2D(_IllumMap, IN.mainTexUV); //MYEDIT
...
#endif // SPEEDTREE_COMMON_EMISSION_INCLUDED